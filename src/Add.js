  ...
  return (
    <>
      ...
      <form onSubmit={(e) => submitHandler(e)} id="addForm">
        Name: <br />
        <input type="text" defaultValue={props.currentAd?.name} name="adName" disabled={disabled} />
        <br />
        Price:
        <br />
        <input type="text" defaultValue={props.currentAd?.price} name="price" disabled={disabled} />
        <br />
        <br />
